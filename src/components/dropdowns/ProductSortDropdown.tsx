                ...
                <Listbox value={sortType} onChange={handleChange}>
                    <div className="relative mt-1">
                        ...
                        <Transition
                            ...
                            leaveTo="opacity-0"
                        >
                            <Listbox.Options className="absolute mt-1 max-h-60 w-full overflow-auto rounded-md bg-white text-base shadow ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
